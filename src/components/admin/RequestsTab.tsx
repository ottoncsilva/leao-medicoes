          ...
          <div className="space-y-4">
               <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 mb-6 bg-white p-2 rounded-xl border border-slate-200">
                    <div className="flex items-center space-x-2 px-2">
                         ...
                         <span className="text-sm font-semibold text-slate-600 sm:hidden">Filtrar por Status</span>
                    </div>
                    <select value={filter} onChange={e => onFilterChange(e.target.value as any)} className="bg-slate-50 sm:bg-transparent border border-slate-200 sm:border-none rounded-lg sm:rounded-none px-3 py-2 text-sm font-medium text-slate-700 focus:ring-blue-500 cursor-pointer w-full sm:w-auto flex-1">
